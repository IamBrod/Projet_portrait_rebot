...
class PortraitRobotApp:
    ...
    def build_page0(self, parent):
        ...
        ctk.CTkLabel(
            container,
            text="Selectionnez les caracteristiques physiques souhaitees\n"
         " et generez plusieurs visages correspondant à vos criteres.\n\n"
         "Vous pouvez choisir un portrait et le faire evoluer \n"
         "jusqu'a obtenir le visage recherche.",
            justify="center",
    ...
    def build_page1(self, parent):
        ...
        ctk.CTkLabel(
            barre_laterale, text="CATEGORIES",
    ...
    def mettre_a_jour_badge(self, cat):
        ...
        if self.categorie_active == cat:
            ...
            self.sous_titre_label.configure(text=", ".join(coches) if coches else "Aucune selection")
